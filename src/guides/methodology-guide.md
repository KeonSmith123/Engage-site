...
- more practical to apply across different role types

- faster to implement than traditional approaches

- easier to maintain as the organisation evolves
...
Many traditional job evaluation methods rely heavily on position descriptions and indirect information about the role.

That can create several problems:

- first-hand role knowledge is excluded from evaluation

- job descriptions can be misunderstood or biased

- the process becomes slow and highly specialist-led

- systems become difficult to maintain over time
...
- **Managerial:** Assesses managerial complexity, especially coordination and business decision-making.

- **Persuasive:** Considers the role’s communication and influence requirements, including selling where relevant.

- **Control:** Looks at organisational control, including staff reporting and site accountability.

- **Impact:** Assesses the role’s level of responsibility and reporting context in the wider organisation.
...
- the scale of control and accountability

- the influence and impact of the role in the organisation
...
- future ambitions for the role

- proficiency of the incumbent

This creates a more disciplined and objective basis for grading.
...
- an executive session to align terms and definitions

- briefing sessions to build awareness

- evaluation sessions with a representative committee

- sense-check sessions to compare roles and refine judgments

- final approval and executive presentation

This process supports greater transparency, stronger internal buy-in, clearer governance, and better long-term sustainability.

## From grids to grades

Once a role has been evaluated across the five grids, the combined output is processed by an algorithm to produce a grade.
...
- stronger internal capability to maintain the methodology

- optional policy and implementation support
...
- create stronger job grades

- support fair pay foundations

- increase trust in grading decisions
