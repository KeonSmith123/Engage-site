---
title: "Job Evaluation for Growing Organisations"
summary: "How fast-growing organisations keep role structure, titles, and grading coherent as headcount and complexity increase."
category: "Org Design"
readtime: "9 min read"
order: 7
gated: true
...
- roles expand quickly

- new functions are added

- reporting lines become more layered

- specialist and managerial roles need to be compared more consistently

- decisions about role size become harder to explain
...
- what role-alignment challenges tend to emerge

- how to maintain consistency during change

- what to look for in a more scalable methodology
...
- more commercially or operationally complex

At the same time, structures become less simple.

- Functions may split.

- New business lines may be created.

- Regional responsibilities may expand.

- Managers may inherit larger spans of control.

- Technical roles may deepen in complexity.
...
- uncertainty about how new roles should be graded

- confusion in career and reporting structures

- growing pressure around fairness and internal relativities
...
- hybrid operational-commercial roles
...
- **Market pressure starts influencing internal decision**s
...
- the influence and impact of the job

- not the performance or negotiating power of the current incumbent.

- **Use a common grading language**
...
- understand grade relationships

- support fair pay foundations

- build clearer career structures

- **Revisit governance before inconsistency grows**

Growth is not only a structural issue. It is also a governance test.

Organisations need clarity on:

- when new roles should be graded

- when existing roles should be re-evaluated

- who has authority to request or approve review

- how role changes are documented
...
- the ability to resize roles practically when the organisation changes
...
- **Less dependent on static job descriptions**
...
- If your organisation is expanding or restructuring, it may be worth asking:

- Can our current grading framework still handle the variety of roles we now have?

- Are we confident that similar roles are being treated consistently?

- Are our job descriptions current enough to support reliable grading?

- Are we starting to solve pay or retention problems through grading decisions?

- Can our methodology keep pace with role and structural change?

- Do we have enough internal understanding to maintain the framework over time?
...
It changes the demands placed on grading frameworks.
...
- a methodology that is practical enough to keep pace
...
- a clearer view of role size

- stronger internal consistency

- a fairer basis for reward

- better alignment across an evolving structure
